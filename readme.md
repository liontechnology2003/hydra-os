...
RedLion OS began as a three‑day low‑level programming challenge. The project follows the learning structure from ([The Little Book About OS Development](https://bit.ly/48JIdWp)) and expands it into a functional monolithic kernel. The long‑term goal is to evolve RedLion OS into a fully usable experimental system. Developers interested in contributing are welcome to fork the repository and open pull requests.

<p align="center">
  <img src="images/banner.jpeg" alt="RedLion OS Banner" title="RedLion OS" width="100%" />
</p>
...
RedLion OS is a monolithic kernel written in x86 Assembly and C. It implements the core components required for a minimal operating system:
...
A bootable ISO file (`redlion.iso`) will be generated automatically.

---

## Roadmap

RedLion OS was created in three days as an educational exercise, but the project is intended to grow. Planned additions:
...
RedLion OS was developed using concepts and guidance from:
...
RedLion OS is an ongoing experimental project. Further development will continue as time permits, and community contributions are welcomed.
